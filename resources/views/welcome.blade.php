...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        <link rel="stylesheet" type="text/css" href="{{asset('css/page.min.css')}}">
              ...
              <div class="row gap-y">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="{{$post->slug}}"><img class="card-img-top" src="/storage/{{$post->image}}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                      <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="{{$post->slug}}">{{$post->category->name}}</a></p>
                      <h5 class="mb-0"><a class="text-dark" href="#">{{$post->title}}</a></h5>
                    </div>
                  </div>
                </div>
                @empty
                No posts for: {{request()->query('search')}}
                @endforelse
